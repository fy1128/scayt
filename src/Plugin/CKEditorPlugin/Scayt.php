 ...
 * )
 */
class Scayt extends PluginBase implements CKEditorPluginInterface, CKEditorPluginButtonsInterface {
   ...
   */
  function getFile() {
    return drupal_get_path('module', 'scayt') . '/js/plugins/scayt/plugin.js';
  }
  ...
  function getButtons() {
    return array(
      'Scayt' => array(
        'label' => t('Spell Check'),
        'image' => drupal_get_path('module', 'scayt') . '/js/plugins/scayt/icons/scayt.png',
      )
    );
  }
